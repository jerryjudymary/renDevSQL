...
const production = new Redis.createClient({
...
const development = new Redis.createClient({
  host: process.env.REDIS_HOST,
  port: process.env.REDIS_PORT,
  db: 2,
  password: process.env.REDIS_PASSWORD,
...
const test = new Redis.createClient({
  host: process.env.REDIS_HOST,
  port: process.env.REDIS_PORT,
  db: 7,
  password: process.env.REDIS_PASSWORD,
...
module.exports = { production, development, test, DEFAULT_EXPIRATION };
